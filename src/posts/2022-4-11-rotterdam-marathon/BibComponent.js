      ...
      <div className={marathonStyles.header}>
        <div className={marathonStyles.headerColumn}>
          <div className={marathonStyles.headerItem}>
            <img
              className={marathonStyles.athleteFlag}
          ...
          <div className={marathonStyles.headerItem}>
            <div className={marathonStyles.athleteRankContainer}>
              ...
              <span className={marathonStyles.athleteRank}>
                {" "}
                {`#${athlete.rank}`}
              </span>
              <span
                className={marathonStyles.athleteRankSub}
              >{`/${total_athletes}`}</span>
            </div>
          </div>
        </div>
        <div className={marathonStyles.headerColumn}>
          ...
          <div className={marathonStyles.headerItem}>
            <p className={marathonStyles.athleteCategory}>
              {" "}
        ...
        <div className={marathonStyles.headerColumn}>
          <div className={marathonStyles.headerItem}>
            <p className={marathonStyles.finishTime}>
              {" "}
              {"Finish time: " + convert_seconds_to_hms(athlete.chipTime)}{" "}
            </p>
          </div>
          <div className={marathonStyles.headerItem}>
            <div className={marathonStyles.athleteRankContainer}>
              <span className={marathonStyles.athleteRankPrefix}>
                Cat. rank:{" "}
              </span>
              <span className={marathonStyles.athleteRank}>
                {" "}
                {`#${athlete.categoryRank}`}
              </span>
              <span
                className={marathonStyles.athleteRankSub}
              >{`/${athletes_in_this_category.length}`}</span>
            </div>
          </div>
        </div>
      </div>
