...
Terraform files to deploy our infrastructure to GCP. At the end of the tutorial, we reduced the deployment
...
this state is stored locally in the file `terraform.tfstate`. However, if we want to deploy our infrastructure through CI/CD
