...
type = "info"
text = <span>
Feel free to use <code>pip</code> instead if that has your preference.
The differences between using <code>pip</code> and using <code>poetry</code> in this tutorial are minimal.
</span>
></TextBox>
