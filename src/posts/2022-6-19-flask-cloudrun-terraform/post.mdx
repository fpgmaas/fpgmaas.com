...
type = "info"
text = <span>
If you are running these steps yourself locally, feel free to use <code>pip</code> instead if that has your preference.
The differences between using <code>pip</code> and using <code>poetry</code> are minimal in this tutorial. 
</span>
></TextBox>
...
port"*<sup> [\[source\]](https://cloud.google.com/run/docs/configuring/containers#configure-port)</sup>.
